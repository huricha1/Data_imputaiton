import argparse
import os
from gap_missing import generatorModel_x,mask_data,loss
import numpy as np
...
parser.add_argument("--window_size", type=int, default=20, help="size of the window")
...
l = loss(torch.from_numpy(gen), torch.from_numpy(testData_ground_truth))
