...
for i in range(1,6):
    train_df[i:train_df.shape[0]:6,1:10:2]=-1.0
    test_df[i:test_df.shape[0]:6,1:10:2]=-1.0
for i in range(1,11):
    train_df[i:train_df.shape[0]:11,11:20:2]=-1.0
    test_df[i:test_df.shape[0]:11,11:20:2]=-1.0
for i in range(1,16):
    train_df[i:train_df.shape[0]:16,21:33:2]=-1.0
    test_df[i:test_df.shape[0]:16,21:33:2]=-1.0
